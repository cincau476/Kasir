...
import * as api from '../api/apiService.js'; // Sesuaikan path jika menggunakan apiService.js
    ...
    <div className="fixed inset-0 z-[150] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-white text-gray-800 rounded-2xl shadow-2xl max-w-md w-full overflow-hidden border border-gray-100 text-left animate-fadeIn">
        ...
        <div className="bg-blue-900 px-6 py-4 flex justify-between items-center">
          <h3 className="text-lg font-bold text-white">Keamanan Autentikasi (MFA)</h3>
          {step === 1 && (
          ...
          {!loading && step === 1 && (
            <div className="text-center">
              <p className="text-sm text-gray-600 mb-4">
                Pindai QR Code di bawah ini menggunakan **Google Authenticator** di ponsel Anda.
              </p>
              ...
              {secretKey && (
                <div className="text-xs text-gray-500 mb-6 bg-gray-50 py-2 px-3 rounded-lg border border-dashed border-gray-300">
                  ...
                  <code className="text-blue-600 font-mono text-sm tracking-wider select-all">{secretKey}</code>
                </div>
              )}
              ...
              <form onSubmit={handleVerifyOtp} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl font-mono text-center text-xl tracking-widest text-gray-900 focus:outline-none focus:border-blue-500 focus:bg-white transition-all"
                    required
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full bg-blue-600 text-white font-bold py-3 rounded-xl hover:bg-blue-700 shadow-md transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Verifikasi & Aktifkan
                </button>
              </form>
          ...
          {!loading && step === 2 && (
            <div>
              <div className="bg-amber-50 border border-amber-200 text-amber-800 rounded-xl p-4 mb-4 text-xs font-medium">
                ⚠️ **PENTING: SIMPAN KODE CADANGAN INI!** Gunakan salah satu kode di bawah ini jika ponsel Anda hilang.
              </div>
